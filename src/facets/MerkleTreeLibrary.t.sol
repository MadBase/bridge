...
contract TestMerkleTreeLibrary is DSTest {
    ...
    function testKeyIsInsideMerkleTree() public {
        bytes memory auditPath = hex"c6136f4517a635e3e56d0011b93c95a03922694646a8d902a4ec2ccfdfaa75dbed37516ea28daa4edc94a63b91d9e63645f4b7a04e3d9739d76b7e2efbb3ab20";
        ...
        bool isInside = MerkleTreeLibrary.checkProof(auditPath, root, keyHash, key, bitset, height, included, proofKey);
        assertTrue(isInside, "The key should be inside");
    }

    //Successful case
    function testKeyIsInsideMerkleTree2() public {
        bytes memory auditPath = hex"066c7a6ef776fbae26f10eabcc5f0eb72b0f527c4cad8c4037940a28c2fe31596974f1d60877fdff3125a5c1adb630afe3aa899820a0531cea8ee6a85eb1150925fc463686d6201f9c3973a9ebeabe4375d5a76d935bbec6cbb9d18bffe67216";
        bytes32 root = hex"51f16d008cec2409af8104a0bca9facec585e02c12d2fa5221707672410dc692";
    ...
    function testKeyIsInsideMerkleTree3() public {
        bytes memory auditPath = hex"066c7a6ef776fbae26f10eabcc5f0eb72b0f527c4cad8c4037940a28c2fe31596974f1d60877fdff3125a5c1adb630afe3aa899820a0531cea8ee6a85eb1150925fc463686d6201f9c3973a9ebeabe4375d5a76d935bbec6cbb9d18bffe67216";
        bytes32 root = hex"51f16d008cec2409af8104a0bca9facec585e02c12d2fa5221707672410dc692";
        bytes32 keyHash = hex"a53ec428ed37200bcb4944a99107b738c1a58ef76287b130583095c58b0f45e4";
        ...
        bool isInside = MerkleTreeLibrary.checkProof2(auditPath, root, keyHash, key, bitset, height, included, proofKey);
        assertTrue(isInside, "The key should be inside");
    }

    function testKeyIsInsideMerkleTree4() public {
        bytes memory auditPath = hex"066c7a6ef776fbae26f10eabcc5f0eb72b0f527c4cad8c4037940a28c2fe31596974f1d60877fdff3125a5c1adb630afe3aa899820a0531cea8ee6a85eb1150925fc463686d6201f9c3973a9ebeabe4375d5a76d935bbec6cbb9d18bffe67216";
        bytes32 root = hex"51f16d008cec2409af8104a0bca9facec585e02c12d2fa5221707672410dc692";
        bytes32 keyHash = hex"a53ec428ed37200bcb4944a99107b738c1a58ef76287b130583095c58b0f45e4";
        ...
        bool isInside = MerkleTreeLibrary.checkProof3(auditPath, root, keyHash, key, bitset, height, included, proofKey);
        assertTrue(isInside, "The key should be inside");
    }
