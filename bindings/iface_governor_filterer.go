...
// IGovernorFilterer ...
type IGovernorFilterer interface {
	...
	FilterValueUpdated(opts *bind.FilterOpts, epoch []*big.Int, key []*big.Int, value [][32]byte) (*GovernorValueUpdatedIterator, error)
	...
	//
	// Solidity: event ValueUpdated(uint256 indexed epoch, uint256 indexed key, bytes32 indexed value, address who)
	WatchValueUpdated(opts *bind.WatchOpts, sink chan<- *GovernorValueUpdated, epoch []*big.Int, key []*big.Int, value [][32]byte) (event.Subscription, error)
	...
	//
	// Solidity: event ValueUpdated(uint256 indexed epoch, uint256 indexed key, bytes32 indexed value, address who)
	ParseValueUpdated(log types.Log) (*GovernorValueUpdated, error)
}
