...
contract TestMerkleTreeLibrary is DSTest {
    ...
    function testIsKeyInsideMerkleTree() public {
        ...
        bytes32 _hash = hex"82f8a0dcf79808641766767fd284413ffc6a7ccc3e170001c5d5acae0ff65a8a";
        ...
        bool isValid = MerkleTreeLibrary.checkProof(proof, root, _hash, key, bitset, height, included, proofKey);
