...
describe("Tests ValidatorPool Business Logic methods", () => {
  ...
  let minimumStakeAmount = 40000;
  let stakeAmount = 30000;
  let minimunStake = ethers.utils.parseUnits(minimumStakeAmount.toString(), 18);
  ...
  it.only("Should set stake amount", async function () {
    ...
    await fixture.validatorPool
      .connect(adminSigner)
      .setStakeAmount(minimumStakeAmount);
    tx = await fixture.stakeNFT
      .connect(adminSigner)
      .mintTo(validator, stakeAmountMadWei, lockTime);
